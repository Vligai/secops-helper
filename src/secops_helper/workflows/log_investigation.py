...
class LogInvestigationWorkflow(Workflow):
    ...
    def _parse_logs(self, context: WorkflowContext) -> StepResult:
        ...
        try:
            ...
            return StepResult(step_name="parse_logs", success=False,
    ...
    def _detect_bruteforce(self, context: WorkflowContext) -> StepResult:
        ...
        return StepResult(step_name="detect_bruteforce", success=True,
                         data={'count': len(brute_force)})
    ...
    def _detect_scanners(self, context: WorkflowContext) -> StepResult:
        ...
        return StepResult(step_name="detect_scanners", success=True,
                         data={'count': len(scanners)})
    ...
    def _extract_attackers(self, context: WorkflowContext) -> StepResult:
        ...
        return StepResult(step_name="extract_attackers", success=True,
                         data={'count': len(attacker_ips)})
