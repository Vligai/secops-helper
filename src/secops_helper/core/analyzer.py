...
class Analyzer:
    ...
    def _check_tool_availability(self):
        ...
        # Check each tool in the tools package
        tools_path = Path(__file__).parent.parent / 'tools'

        tool_paths = {
            'hash_lookup': tools_path / 'hash_lookup.py',
            'ioc_extractor': tools_path / 'ioc_extractor.py',
            'domain_intel': tools_path / 'domain_ip_intel.py',
            'url_analyzer': tools_path / 'url_analyzer.py',
            'eml_parser': tools_path / 'eml_parser.py',
            'log_analyzer': tools_path / 'log_analyzer.py',
            'pcap_analyzer': tools_path / 'pcap_analyzer.py',
            'yara_scanner': tools_path / 'yara_scanner.py',
            'deobfuscator': tools_path / 'deobfuscator.py',
            'cert_analyzer': tools_path / 'cert_analyzer.py',
        }
