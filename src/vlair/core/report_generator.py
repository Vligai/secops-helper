...
class ReportGenerator:
    ...
    def _generate_filename(self, data: ReportData, ext: str) -> str:
        ...
        return f"vlair_report_{input_type}_{timestamp}{ext}"
...
<head>
    ...
    <title>vlair Analysis Report - {html_escape(data.input_value)}</title>
    <style>
...
<body>
    ...
    <div class="report-footer">
        <p>Generated by vlair v4.0.0 | Operationalization Phase 5</p>
    ...
    def format_markdown(self, data: ReportData) -> str:
        ...
        return f"""# vlair - Analysis Report
...
*Generated by vlair v4.0.0 | All IOCs are defanged for safe display.*
"""
    ...
    def _md_metadata(self, data: ReportData) -> str:
        ...
        lines = ["## Metadata"]
        lines.append("")
        lines.append(f"- **Tool Version:** vlair v4.0.0")
